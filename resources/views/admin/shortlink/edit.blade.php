...
@section('content')
  ...
  <div class="row">
    <div class="col-xl-9 mx-auto">
      <h6 class="mb-0 text-uppercase">Edit Link</h6>
      <hr/>
      <div class="card">
        <div class="card-body">
          <div class="border p-3 p-md-4 rounded">
            <div class="card-title d-flex align-items-center">
              <h5 class="mb-0">Edit the Short link</h5>
            </div>
            <hr/>
            <form action="/admin/shortlink/{{ $shortlink->short }}" method="POST">
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-9 col-sm-8">
                  <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter name of the short link" value="{{ old('name', $shortlink->name) }}">
                  @error('name')
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-9 col-sm-8">
                  <input type="text" class="form-control @error('original') is-invalid @enderror" id="original" name="original" placeholder="Enter the original link" value="{{ old('original', $shortlink->original) }}">
                  @error('original')
                  <div class="invalid-feedback">
                    <p class="ps-2 mb-0">{{ $message }}</p>
                  </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-md-9 col-sm-8">
                  <div class="input-group mb-3"> 
                    ...
                    <input type="text" class="form-control @error('short') is-invalid @enderror" id="short" name="short" aria-describedby="basic-addon3" placeholder="Enter the short link" value="{{ old('short', $shortlink->short) }}">
                    @error('short')
                    <div class="invalid-feedback">
                      <p class="ps-2 mb-0">{{ $message }}</p>
                    </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                  <button type="submit" class="btn btn-primary px-5">Edit Short Link!</button>
                </div>
              </div>
            </form>
          </div>
